...
class SmoothCTCLoss(nn.Module):
    ...
    def __init__(self, num_classes= 2892, blank=0, zero_infinity=True, weight=0.01):
    #def __init__(self, num_classes=10882000, blank=0, zero_infinity=True, weight=0.01):
        super().__init__()
        self.weight = weight
        self.num_classes = num_classes

        self.ctc = nn.CTCLoss(reduction='mean', blank=blank, zero_infinity=zero_infinity)
